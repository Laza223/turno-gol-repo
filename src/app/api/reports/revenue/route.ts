 ...
 *
 * Solo admin (2026-09-19), como /analiticas —desde donde sale el botón de
 * descarga— y /api/admin/metrics: la plata del negocio en bloque es del dueño.
 * B10: antes validaba sólo `user.type === 'staff'` + `getStaffTenant`,
