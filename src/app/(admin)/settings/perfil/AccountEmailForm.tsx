    ...
    <form onSubmit={handleSubmit} className="max-w-md space-y-4">
      ...
      <div>
        ...
        <input
          ...
          required
          className="mt-1 flex h-11 md:h-10 w-full rounded-lg border border-border bg-background px-3 py-2 text-base md:text-sm text-foreground ring-offset-background placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2"
        />
      </div>
