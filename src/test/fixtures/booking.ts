...
export const saturdayAfternoonGrid = (): BookingRow[] => {
  ...
  return [
    ...
    booking({
      ...
      paymentMethod: 'cash',
      paymentId: null,
      guestName: 'Grupo Los Pibes de Once',
    }),
    booking({
      id: uid(1104),
      courtId: f5,
    ...
    booking({
      ...
      playerId: null,
      createdByStaff: staffId,
      guestName: 'Equipo Contadores SRL',
    }),
    booking({
      id: uid(1108),
      courtId: f7,
    ...
    booking({
      ...
      paymentMethod: 'cash',
      paymentId: null,
      guestName: 'Los Amigos del Barrio Once',
    }),
    booking({
      id: uid(1111),
      courtId: f7,
    ...
    booking({
      ...
      paymentMethod: 'cash',
      paymentId: null,
      guestName: 'Cumpleaños de Valentina — 15 amigas',
    }),
    ...
    booking({
      ...
      depositStatus: 'captured',
      playerId: null,
      guestName: 'Grupo Corporativo Alvear',
    }),
    booking({
      id: uid(1114),
      courtId: f11,
    ...
    booking({
      ...
      paymentMethod: 'cash',
      paymentId: null,
      guestName: 'Torneo Interbarrial — Semifinal',
    }),
    booking({
      id: uid(1116),
      courtId: f11,
    ...
    booking({
      ...
      paymentMethod: 'cash',
      paymentId: null,
      guestName: 'Selección de Ex-alumnos — Promoción 2016',
    }),
  ]
}
