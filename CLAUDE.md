...
La carpeta `docs/` contiene 20 documentos que son la fuente de verdad del proyecto. Están numerados del 1 al 20 y cubren todas las capas:
...
- `doc7` — 12 flujos end-to-end con efectos secundarios detallados
- `doc8` — 51 user stories con Given/When/Then, edge cases, out-of-scope
...
- `doc20` — Design System: UI/UX Pro Max como generador, MASTER.md como persistencia
...
- Server Actions para mutaciones, no Route Handlers (salvo webhooks)
...
## Multi-tenancy
- **19 tablas totales**: 12 aisladas con RLS + 7 globales
...
- Tablas globales: tenants, players, staff_users, plans, price_versions, processed_webhooks, player_tenant_relationships
...
- `player_status`: active, banned, suspended, anonymized (el último para eliminación ARCO Ley 25.326)
