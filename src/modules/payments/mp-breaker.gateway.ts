...
export function withCircuitBreaker(
  ...
  return {
    ...
    getSubscriptionChargeInfo: (id) =>
      breaker.execute(key, () => inner.getSubscriptionChargeInfo(id)),
    getSubscriptionState: (id) => breaker.execute(key, () => inner.getSubscriptionState(id)),
