...
>(({ className, align = 'center', sideOffset = 4, collisionPadding = 8, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        // max-h: sin tope, un popover alto (calendario, lista de países) se
        // corta contra el viewport en pantallas bajas sin poder scrollear.
        'z-50 w-72 max-h-[70dvh] overflow-y-auto rounded-xl border border-border bg-popover p-4 text-popover-foreground shadow-lg outline-hidden',
