...
export default function SearchBand({ cities }: { cities: CityCount[] }) {
  return (
    <section
      className="relative isolate overflow-hidden rounded-3xl border border-white/[.08] px-5 py-7 sm:px-9 sm:py-9"
      style={{
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute right-[-10%] top-[-70%] -z-10 h-[480px] w-[480px] rounded-full blur-[12px]"
