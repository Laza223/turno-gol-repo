...
`Leé design-system/MASTER.md. La app del jugador debe ser mobile-first con diseño premium. Priorizá usabilidad táctil y tiempos de carga.`
```
...
Leé design-system/MASTER.md y doc20. El dashboard debe sentirse como un SaaS premium moderno. Usá los tokens de color, tipografía y spacing definidos.
