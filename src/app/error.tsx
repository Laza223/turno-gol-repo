...
/**
 * Root error boundary. Catches render/runtime errors thrown below the root
 * layout. Reports to Sentry and offers recovery (retry) + a safe exit (home).
 */
    ...
    <main className="flex min-h-dvh items-center justify-center bg-slate-50 px-4 py-12">
      <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-8 text-center shadow-lg">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-500">
          Tuvimos un problema inesperado. Ya quedó registrado y lo estamos
          revisando. Podés reintentar en unos segundos o volver al inicio.
        </p>
        {error.digest ? (
