...
export type BookingCanceledData = {
...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#1e293b">
  ...
  <p>Tu reserva en <strong>${data.tenantName}</strong> fue cancelada.</p>
