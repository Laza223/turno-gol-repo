...
- **Impacto en código/docs**:
  - [x] `docs/spec/doc7_flujos_e2e.md` — Flujo 4C, reestructurar el modal de cancelación
  - [x] UI del panel admin — modal de cancelación con paso previo de motivo (BookingActions + QuickActions)
...
#### Impacto en docs
- [x] `docs/spec/doc7_flujos_e2e.md` — Flujo 2 y 3: agregar paso de cobro del resto al llegar
...
## 🎯 Auditorías de Arquitectura (Post-Launch)
