// 3 niveles fijos de rol de staff (migración 026). NO es RBAC granular:
// cada rol mapea a un set cerrado de vistas, sin permisos configurables.
...
export const STAFF_ROLES = ['admin', 'manager', 'read_only'] as const
...
export const STAFF_ROLE_DESCRIPTIONS: Record<StaffRole, string> = {
  ...
  read_only: 'Solo puede ver reportes.',
}
