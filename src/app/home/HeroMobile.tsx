...
/**
 * Hero mobile/tablet (<lg). JSX congelado desde el rediseño dark-premium
 * original — el único cambio respecto a esa versión es `lg:hidden` en el
 * <section> raíz, para cederle el paso a HeroDesktop en desktop. No tocar
 * las clases internas: HeroDesktop.tsx es donde vive la iteración visual.
 */
export function HeroMobile({ cities }: { cities: CityCount[] }) {
  return (
    <section className="relative flex min-h-[84vh] items-center overflow-hidden px-4 pt-[110px] pb-[64px] sm:px-6 sm:pt-[120px] sm:pb-[84px] lg:hidden">
