      ...
      <div className="mx-auto max-w-[1240px] px-4 sm:px-6">
        <Reveal>
          <div className="mb-[34px] flex flex-wrap items-end justify-between gap-6">
            ...
            <Link
              href="/explorar"
              className="group inline-flex h-11 shrink-0 items-center gap-2 rounded-full border border-border bg-card px-6 text-sm font-semibold text-foreground shadow-xs transition-[background-color,scale] hover:bg-accent active:scale-[0.98] dark:border-white/15 dark:bg-white/5 dark:hover:bg-white/10"
            >
              Ver todos
              <ArrowRight
