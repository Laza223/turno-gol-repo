...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#1e293b">
  ...
  <p style="text-align:center;margin:24px 0">
    <a href="https://turnogol.com.ar/configuracion/facturacion" style="background:#dc2626;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:600">Actualizar método de pago →</a>
  </p>
