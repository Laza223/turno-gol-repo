# 07 — Objeciones probables y respuestas

> Documento vivo: después de cada demo perdida, anotar la objeción real (columna `objecion_principal` del CRM) y, si es nueva, sumarla acá con la respuesta que funcionó. Regla general: primero validar ("tiene lógica lo que decís"), después responder con mecánica del producto, nunca con promesas.
...
## Las del que conoce el mercado

**11. "¿Ya lo usa alguien? ¿Quién?"**
> [Primeros clientes — honestidad total:] "Estás entre los primeros, no te voy a mentir. Por eso el trato es distinto: gratis el primer mes, te lo configuro yo, tenés mi celular directo, y [precio fundador si aplica]. Los que entran ahora tienen un trato que después no voy a poder dar." — [Con 3+ clientes:] nombrar complejos de la zona (con permiso) y ofrecer que los llame.

**12. "Ya uso ATC" / "Probé ATC y lo dejé"**
> Primero: "¿Qué te funcionó y qué no?" — Si recibe muchas reservas del marketplace de ATC: retirarse con elegancia ("entonces te está sirviendo, no te voy a hacer perder eso — quedate con mi contacto por si algo cambia"). Anotar como `no-ICP`. — Si lo usa a medias o lo dejó: "Es que ATC es para todos los deportes y está pensado para la compu. Esto es solo fútbol y lo manejás desde el celu. Sale menos por mes [verificar precio ATC vigente antes de afirmarlo] y te lo dejo andando en un día. La carga inicial de tus datos la hago yo a mano, no perdés nada."

**13. "¿Me traés jugadores nuevos?"**
> [NO inflar:] "No, y el que te diga que sí te está vendiendo humo salvo que tenga una app con miles de pibes adentro. TurnoGol te ordena la demanda que YA tenés — el Instagram, los que te escriben, los de siempre — y hace que reserven y señen solos. Traerte gente nueva es trabajo de tu Instagram, y ahí te dejo textos listos para publicar que te van a servir."

**14. "¿Y si ustedes cierran? / ¿mis datos?"**
...
- Tres "no tengo tiempo" seguidos sin proponer fecha = no le interesa → break-up ([06 §6](./06-scripts.md)).
- Pide descuento antes de la demo = compara precio, no valor → baja prioridad.
- "Mandame TODO por escrito" sin querer charlar nunca = no decide él o no le duele → break-up.
- Complejo pádel-céntrico o dependiente del marketplace de ATC = `no-ICP`, salir bien y rápido.
