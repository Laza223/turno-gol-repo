...
- **D4 — Reservas por cancha.** `/reservas` sin hero y a ancho completo; los controles (Hoy/Próximas/Historial, búsqueda, Filtros) suben a la barra superior; Estado y Cancha pasan a un popover "Filtros". Hoy y Próximas se ven en **columnas por cancha**, cada una con su scroll; con muchas canchas se desliza horizontal. Historial sigue como lista. Se elimina el toggle de densidad.
