...
- ⚠️ **RESUELTO 2026-08-07 — este ítem quedó histórico.** Se movieron los CORTES de TurnoGol para que coincidan con los de ATC (migr. 071): **1-3 / 4-6 / 7+ a $63.000 / $99.000 / $129.000**, contra los $71.000 / $111.000 / $145.000 que ATC lista al 2026-08-07 (navegación del founder desde IP argentina; subió ~7-8% desde julio). Con los cortes alineados la comparación deja de ser cruzada y **TurnoGol queda ~11% abajo en las tres franjas, sin excepciones** — las dos que perdían son justamente las que más bajan de precio. Fundamento: `docs/planning/2026-08-07-analisis-rubro-y-decisiones.md` §4.5. **PERO** la comparación depende de un dato todavía abierto: el IVA (ver §4.6 de ese doc — `doc4` decía "+21% en el checkout" y el código no lo implementa; si el precio no es final, la ventaja del 11% se vuelve desventaja del 7%). Hasta cerrar eso, la regla de abajo sigue vigente: **cero claims de precio**.

- `HECHO` (aritmética sobre la captura de julio — **estado previo, conservado como registro**) — **la comparación real es POR FRANJA, no global, porque los rangos difieren** (ATC corta en 1-3/4-6/7+; TurnoGol en 1-2/3-5/6+): con 1-2 canchas TurnoGol gana ($55k vs $66k, -17%); con **3 canchas ATC gana** ($66k vs $85k — TurnoGol +29% más caro); con 4-5 TurnoGol gana ($85k vs $104k, -18%); con **6 canchas ATC gana** ($104k vs $115k); con 7+ TurnoGol gana ($115k vs $136k, -15%). **Las dos franjas donde TurnoGol pierde (3 y 6 canchas) caen ADENTRO del ICP-1 (3-6 canchas).** Mitigación ya disponible: el precio fundador de doc4 (20-30% off) deja Complejo en $59.500-68.000 — tapa la brecha de la franja de 3 casi exacto. Decisión de boundaries en §21.11.
