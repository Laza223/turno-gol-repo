...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#1e293b">
  ...
  <table style="width:100%;border-collapse:collapse;margin:16px 0">
    <tr><td style="padding:8px 0;border-bottom:1px solid #e2e8f0;font-weight:600;width:40%">Complejo</td><td style="padding:8px 0;border-bottom:1px solid #e2e8f0">${escapeHtml(data.tenantName)}</td></tr>
    ...
    <tr><td style="padding:8px 0;font-weight:600">Dirección</td><td style="padding:8px 0">${escapeHtml(data.tenantAddress)}</td></tr>
  </table>
