...
- **Globales sin RLS** (sin tenant_id y sin policies): tenants, plans, price_versions, processed_webhooks. El rol de la app las lee y escribe, pero **no las borra** y el catálogo comercial es de sólo lectura (migr. 083).
