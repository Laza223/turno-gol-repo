...
**TurnoGol es vendible cara a cara, con el argumento de la plata (ausentes y caja), a complejos de 3-6 canchas. No es vendible todavía por canales fríos masivos, y no compite aún donde ATC es fuerte (la app de jugadores de ATC).**

## Score honesto por dimensión

| Dimensión | Score | Por qué |
|---|---|---|
| Dolor del cliente | 8/10 | Real y cuantificable: ausentes ($64-128k/mes perdidos en un complejo de 4 canchas según doc1 — ⚠️ HIPÓTESIS interna, validar con cada dueño), teléfono que no para, caja a ojo, abonados que deben. |
...
| Producto | 7/10 | Superficie competitiva real (ver lista abajo). Falta: aviso por WhatsApp al jugador, cobro automático de abonados, app de jugadores con tráfico. Puesta en marcha <20 min es diferencial real vs 1-7 días de ATC. |
...
- **Seña por MercadoPago directo a la cuenta MP del complejo** (conectás tu MercadoPago): TurnoGol no toca la plata. Porcentaje configurable, se puede apagar. Si el jugador no paga en minutos, el turno se libera solo.
- **Ausencia con bloqueo automático**: si te cuelgan el turno, la seña queda para el complejo. Y al reincidente (2da ausencia en 90 días) el sistema le bloquea solo las reservas online en ese complejo por 14 días. **NO hay deuda de dinero por ausencia** (modelo revertido 2026-07-11): el único costo para el jugador es la seña + el bloqueo.
- **Grilla en tiempo real, pensado para el celular**: la reserva entra y la ve el dueño desde el celu, esté donde esté. Aviso al celular con cada reserva (con horario silencioso: de madrugada no suena, avisa a las 8).
...
- **Puesta en marcha ~15-20 min** + prueba gratis 30 días sin tarjeta (ya construido en el producto).
- **Métricas**: pantalla de números con caja, ocupación, KPIs.
...
2. **ATC tiene la app de jugadores.** Un complejo que recibe demanda desde la app de ATC no puede reemplazar eso con TurnoGol hoy. **No pelear por esos clientes en los primeros 90 días.**
...
5. **Sin WhatsApp automático al jugador** (v1 es email + aviso al celular). En Argentina el dueño va a preguntar por WhatsApp sí o sí. Respuesta honesta preparada en [07-objeciones.md](./07-objeciones.md).
...
1. **Vender a quien no va a activar.** Un dueño que paga pero cuyos jugadores nunca usan el link se da de baja seguro a los 60 días. La activación (primera reserva online) es parte de la venta, no del soporte. Por eso el piloto incluye kit de lanzamiento obligatorio ([04](./04-oferta-piloto.md)).
2. **Prometer el futuro.** "Ya viene WhatsApp", "pronto cobro automático de abonados", "te vamos a traer jugadores". Cada una compra hoy y se da de baja mañana. Lista prohibida en [10-playbook-ia.md](./10-playbook-ia.md).
...
- El gancho de venta es **la plata, no la tecnología**: "los turnos colgados te cuestan $X por mes; con la seña, si te cuelgan el turno, la seña queda para vos". Mecánico, verificable, sin prometer porcentajes inventados.
