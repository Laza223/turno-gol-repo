...
export function StepCourts({ existingCourts, tenantId, createCourtsAction }: Props) {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      // trabajo pendiente y restaurarlo en una revisita mostraría duplicados.
      clearStoredDrafts()
      navigate(result)
    })
  }
    ...
    >
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* "Volver" es un link, no una Server Action: ahora que el paso vive en la
            URL, retroceder es navegar. Antes escribía en DB para bajar
            `onboarding_step`, o sea que hacía falta un round-trip al server para
            algo que el botón atrás del navegador ya sabía hacer. */}
