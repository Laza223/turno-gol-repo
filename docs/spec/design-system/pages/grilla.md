...
- **Cobrar por equipo** (2026-09-15): debajo del botón grande, **"Cobrar la mitad — $X"**, sólo mientras no haya entrado ningún cobro de mostrador. Es la forma en que cobra la mayoría de los complejos —una vez por equipo—, así que es un botón y no el link gris de abajo. Desaparece con el primer cobro, porque ahí el botón grande ya dice exactamente lo que falta; en su lugar el resumen de plata rotula **"Equipo 1 pagó · falta Equipo 2"**. El rótulo es presentación, no un dato guardado, y la seña **no** cuenta como equipo que pagó. Decisión: `docs/decisions/2026-09-15-cobro-por-equipo.md`
