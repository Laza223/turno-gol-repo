 ...
 * atención arriba, el tablero de turnos y el registro plegado — y, desde `xl`,
 * la columna de venta a la derecha. La banda `PageHeader` salió en el rediseño
 * del 2026-09-12 (el título y la fecha viven en la barra superior del panel) y
 * esta silueta la siguió: un esqueleto que dibuja algo que ya no llega es peor
